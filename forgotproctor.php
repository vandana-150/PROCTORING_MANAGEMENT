                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <form id="register-form" role="form" action="forgotproctor.php" autocomplete="off" class="form" method="post">
                            ...
                            <div>
                                Remember?    <a href="loginproctor.php" style="text-decoration: none;font-size:15px">Signup</a>
                            </div>
                            ...
                            <?php
                                ...
                                if(isset($_POST['recover-submit'])){
                                    $var=$_POST['email'];
                                    $query="select * from proctorlogin where email='$var'";
                                ...
                                http://localhost/proctoring/resetproctor.php
                                With Regards
                                Admin
