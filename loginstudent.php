   ...
   <body>
    <nav>
      ...
      <div class="login-box">
        ...
        <form method="post" name="login" onsubmit="return valid();" action="loginstudent.php">
            <div class="user-box">
            ...
            <button onclick="location.replace('forgot.php')">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
...
if(isset($_POST['submit']))
{
    ...
    $query=mysqli_query($con,"select * from studentlogin where studentid='$username' and password='$password'");
...
{
    $_SESSION["regno"]=$_POST['username'];
    echo "<script>alert('logged in successfully');</script>";
    echo '<script>window.location.href="studentsidebar.php"</script>';
}
}
?>