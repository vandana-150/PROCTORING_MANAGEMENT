...
<div data-component="sidebar">
    ...
    <form class="well form-horizontal" action="studentadd.php" method="post" onsubmit="return valid();" id="contact_form" style="margin: 5%;">
<fieldset>

<!-- Form Name -->
<legend><h2 style="text-align:center;">Add Student</h2></legend>

<div class="form-group">
  <label class="col-md-4 control-label">PROCTORID</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
    <input name="proctorid" placeholder="ENTER PROCTORID" class="form-control" type="text"> 
    </div>
  </div>
</div>
<div class="form-group">
  <label class="col-md-4 control-label">STUDENTID</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
    <input name="studentid" placeholder="ENTER STUDENTID" class="form-control" type="text">
    </div>
  </div>
</div>
