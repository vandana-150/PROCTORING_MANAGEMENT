...
<html>
    ...
    <body>
        ...
        <label>DC</label><input type="text" name="english1" class="input-field" value="<?php echo $query1["dc"];?>" required>
        <label>MPI</label><input type="text" name="m11" class="input-field" value="<?php echo $query1["mpi"];?>" required>
        <label>OS</label><input type="text" name="chemistry1" class="input-field" value="<?php echo $query1["os"];?>" required>
        <label>CO</label><input type="text" name="bee1" class="input-field" value="<?php echo $query1["co"];?>" required>
        <label>FLAT</label><input type="text" name="pehv1" class="input-field" value="<?php echo $query1["flat"];?>" required>
            ...
            <label>DC</label><input type="text" name="english2" class="input-field" value="<?php echo $query2["dc"];?>" required><br>
            <label>MPI</label><input type="text" name="m12" class="input-field" value="<?php echo $query2["mpi"];?>" required><br>
            <label>OS</label><input type="text" name="chemistry2" class="input-field" value="<?php echo $query2["os"];?>" required><br>
            <label>CO</label><input type="text" name="bee2" class="input-field" value="<?php echo $query2["co"];?>" required><br>
            <label>FLAT</label>   <input type="text" name="pehv2" class="input-field" value="<?php echo $query2["flat"];?>" required><br>
            ...
            <form id="sem1form" name="sem1" action="midmarks.php" method="post" onsubmit="return valid3();" class="input-group">
                <label>DC</label><input type="text" name="english3" class="input-field" value="<?php echo $query3["dc"];?>" required><br>
                <label>MPI</label><input type="text" name="m13" class="input-field" value="<?php echo $query3["mpi"];?>" required><br>
                <label>OS</label><input type="text" name="chemistry3" class="input-field" value="<?php echo $query3["os"];?>" required><br>
                <label>CO</label><input type="text" name="bee3" class="input-field" value="<?php echo $query3["co"];?>" required><br>
                <label>FLAT</label><input type="text" name="pehv3" class="input-field" value="<?php echo $query3["flat"];?>" required><br>
                <label>MPI LAB</label><input type="text" name="chemistrylab3" class="input-field" value="<?php echo $query3["mpilab"];?>" required><br>
                <label>OS LAB</label><input type="text" name="clab3" class="input-field" value="<?php echo $query3["oslab"];?>" required><br>
                <label>HARDWARE LAB</label><input type="text" name="hardwarelab" class="input-field" value="<?php echo $query3["hardwarelab"];?>" required><br>
...
if(isset($_POST['mid1submit']))
{
    ...
    $bee=$_POST['bee1'];
    $pehv=$_POST['pehv1'];
    $query="update mid1 set dc='$english',mpi='$m1',os='$chemistry',co='$bee',flat='$pehv' where studentid='$regno'";
...
else if(isset($_POST['mid2submit']))
{
    ...
    $bee=$_POST['bee2'];
    $pehv=$_POST['pehv2'];
    $query="update mid2 set dc='$english',mpi='$m1',os='$chemistry',co='$bee',flat='$pehv' where studentid='$regno'";
    if(!mysqli_query($con,$query))
    {
        echo "not inserted";
    }
...
else if(isset($_POST['sem1submit']))
{
    ...
    $clab=$_POST['clab3'];
    $hardwarelab=$_POST['hardwarelab'];
    $query="update sem1 set dc='$english',mpi='$m1',os='$chemistry',co='$bee',flat='$pehv',mpilab='$chemistrylab',oslab='$clab',hardwarelab='$hardwarelab' where studentid='$regno'";
    if(!mysqli_query($con,$query))
    {
