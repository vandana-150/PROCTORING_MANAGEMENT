      ...
      <div class="sidebar">
        <ul class="list-group flex-column d-inline-block first-menu">
          <li class="list-group-item pl-3 py-2">
            <a href=""><i class="fas fa-user"></i><span class="ml-2 align-middle">PROCTOR</span></i></a>
          ...
          <li class="list-group-item pl-3 py-2">
            <a href="#"><i class="fas fa-user"></i><span class="ml-2 align-middle">STUDENT</span></i></a>
            <ul class="list-group flex-column d-inline-block submenu" style="margin-top: 1%;">
              <li class="list-group-item pl-4" style="margin-top:20%;">
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="coordinatorprofile.php" onsubmit="return validateImage();"name="update" method="POST" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name='phone' id="phone" value="<?php  echo $row['phone']?>" placeholder="enter phone" >
            </div>
            <div class="form-group">
              <label class="form-label" style="color: black;">Experience:</label>
              <input type="text" class="form-control" name='experience' id="experience" value="<?php  echo $row['experience']?>" placeholder="enter experience" >
            </div>
        ...
        <div class="modal-footer">
          ...
          <?php
            if(isset($_POST['changebnt']))
            {
              ...
              $query="update coordinatorlogin set password='$new_pass' where email= '$before'";
              ...
              echo '<script>window.location.href="coordinatorprofile.php"</script>';
...
<?php
  if(isset($_POST['submit'])){
    ...
    $query="update coordinatorlogin set name='$modified_name',email='$modified_address',phone='$modified_phone',experience='$modified_blood'";
              ...
              if ($error == 0) {
                if ($img_size > 1024000) {
                  ...
                  if (in_array($img_ex_lc, $allowed_exs)) {
                    ...
                    $user=$_SESSION["user"];
                    $query="update coordinatorlogin set profilepic='$new_img_name' where username= '$user'";
