...
<html>
    ...
    <body>
        ...
        <label>OE 1</label><input type="text" name="english1" class="input-field" value="<?php echo $query1["oe1"];?>" required>
        <label>DBMS</label><input type="text" name="m11" class="input-field" value="<?php echo $query1["dbms"];?>" required>
        <label>CG</label><input type="text" name="chemistry1" class="input-field" value="<?php echo $query1["cg"];?>" required>
        <label>CN</label><input type="text" name="bee1" class="input-field" value="<?php echo $query1["cn"];?>" required>
        <label>DAA</label><input type="text" name="pehv1" class="input-field" value="<?php echo $query1["daa"];?>" required>
            ...
            <label>OE 1</label><input type="text" name="english2" class="input-field" value="<?php echo $query2["oe1"];?>" required><br>
            <label>DBMS</label><input type="text" name="m12" class="input-field" value="<?php echo $query2["dbms"];?>" required><br>
            <label>CG</label><input type="text" name="chemistry2" class="input-field" value="<?php echo $query2["cg"];?>" required><br>
            <label>CN</label><input type="text" name="bee2" class="input-field" value="<?php echo $query2["cn"];?>" required><br>
            <label>DAA</label>   <input type="text" name="pehv2" class="input-field" value="<?php echo $query2["daa"];?>" required><br>
            ...
            <form id="sem1form" name="sem1" action="midmarks.php" method="post" onsubmit="return valid3();" class="input-group">
                <label>OE 1</label><input type="text" name="english3" class="input-field" value="<?php echo $query3["oe1"];?>" required><br>
                <label>DBMS</label><input type="text" name="m13" class="input-field" value="<?php echo $query3["dbms"];?>" required><br>
                <label>CG</label><input type="text" name="chemistry3" class="input-field" value="<?php echo $query3["cg"];?>" required><br>
                <label>CN</label><input type="text" name="bee3" class="input-field" value="<?php echo $query3["cn"];?>" required><br>
                <label>DAA</label><input type="text" name="pehv3" class="input-field" value="<?php echo $query3["daa"];?>" required><br>
                <label>DBMS LAB</label><input type="text" name="chemistrylab3" class="input-field" value="<?php echo $query3["dbmslab"];?>" required><br>
                <label>CN LAB</label><input type="text" name="clab3" class="input-field" value="<?php echo $query3["cnlab"];?>" required><br>
                <label>SOFTSKILLS LAB</label><input type="text" name="softskillslab" class="input-field" value="<?php echo $query3["softskillslab"];?>" required><br>
                <label>QA & VA</label><input type="text" name="qava1" class="input-field" value="<?php echo $query3["qava1"];?>" required><br>
...
if(isset($_POST['mid1submit']))
{
    ...
    $bee=$_POST['bee1'];
    $pehv=$_POST['pehv1'];
    $query="update mid1 set oe1='$english',dbms='$m1',cg='$chemistry',cn='$bee',daa='$pehv' where studentid='$regno'";
...
else if(isset($_POST['mid2submit']))
{
    ...
    $bee=$_POST['bee2'];
    $pehv=$_POST['pehv2'];
    $query="update mid2 set oe1='$english',dbms='$m1',cg='$chemistry',cn='$bee',daa='$pehv' where studentid='$regno'";
    if(!mysqli_query($con,$query))
    {
        echo "not inserted";
    }
...
else if(isset($_POST['sem1submit']))
{
    ...
    $clab=$_POST['clab3'];
    $softskillslab=$_POST['softskillslab'];
    $qava1=$_POST['qava1'];
    $query="update sem1 set oe1='$english',dbms='$m1',cg='$chemistry',cn='$bee',daa='$pehv',dbmslab='$chemistrylab',cnlab='$clab',softskillslab='$softskillslab',qava1='$qava1' where studentid='$regno'";
    if(!mysqli_query($con,$query))
    {
