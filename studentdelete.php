...
<div data-component="sidebar">
    ...
    <script src="https://kit.fontawesome.com/b99e675b6e.js"></script>
        <div id="search">
            <form action="studentdelete.php" name="student" onsubmit="return valid();" method="post">
            ...
            <div class="searchresults">
                ...
                <?php
                 if(isset($_POST['search']) && isset($_POST['studentid']))
                 {
                  ...
                  while($row=mysqli_fetch_assoc($query))
                  {
                      ...
                      <centre>
                      <td><form action="studentdelete.php" method="post">
                ...
                if(isset($_POST['delete']))
                {
                    ...
                    echo '<script>window.location.href="studentdelete.php"</script>';
                }
               ?>
            </div>
        </div>
