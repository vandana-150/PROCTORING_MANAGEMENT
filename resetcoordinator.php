                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <form id="register-form" role="form" action="resetcoordinator.php" autocomplete="off" class="form" method="post">
                            ...
                            <?php
                                ...
                                if(isset($_POST['recover-submit']))
                                {
                                    ...
                                    {
                                        $query="update coordinatorlogin set password='$cur' where email='$mail'";
                                        if($row = mysqli_query($con,$query))
                                        {
                                            ?>
                                            <div class="alert alert-success alert-dismissible">
                                               <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                               Password is reseted Successfully!! Click Here to <a href="logincoordinator.php"><strong>Login</strong></a>
                                           </div>
                                           <?php
