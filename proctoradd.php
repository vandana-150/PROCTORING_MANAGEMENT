...
<div data-component="sidebar">
    ...
    <form class="well form-horizontal" action="proctoradd.php" method="post" onsubmit="return validate();" id="contact_form" style="margin: 5%;">
<fieldset>

<!-- Form Name -->
<legend><h2 style="text-align:center;">Add Proctor</h2></legend>
