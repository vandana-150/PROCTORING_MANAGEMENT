...
<div data-component="sidebar">
    ...
    <div class="hero">
            ...
            <form id="mid1form" action="sem2.php" class="input-group">

        <label>M2</label><input type="text" class="input-field" value="<?php echo $query1["m2"];?>">
        <label>PHYSICS</label><input type="text" class="input-field" value="<?php echo $query1["physics"];?>">
        <label>ES</label><input type="text" class="input-field" value="<?php echo $query1["es"];?>">
        <label>ED</label><input type="text" class="input-field" value="<?php echo $query1["ed"];?>">
        <label>BEEE</label><input type="text" class="input-field" value="<?php echo $query1["beee"];?>">
               <button type="submit" class="submit-btn">Edit</button>
            </form>

            <form id="mid2form"action="sem2.php" class="input-group">
            <label>M2</label><input type="text" class="input-field" value="<?php echo $query2["m2"];?>"><br>
            <label>PHYSICS</label><input type="text" class="input-field" value="<?php echo $query2["physics"];?>"><br>
            <label>ES</label><input type="text" class="input-field" value="<?php echo $query2["es"];?>"><br>
            <label>ED</label><input type="text" class="input-field" value="<?php echo $query2["ed"];?>"><br>
            <label>BEEE</label>   <input type="text" class="input-field" value="<?php echo $query2["beee"];?>"><br>
               <button type="submit" class="submit-btn">Edit</button>
            </form>

            <form id="sem1form" action="sem2.php"class="input-group">
                <label>M2</label><input type="text" class="input-field" value="<?php echo $query3["m2"];?>"><br>
                <label>PHYSICS</label><input type="text" class="input-field" value="<?php echo $query3["physics"];?>"><br>
                <label>ES</label><input type="text" class="input-field" value="<?php echo $query3["es"];?>"><br>
                <label>ED</label><input type="text" class="input-field" value="<?php echo $query3["ed"];?>"><br>
                <label>BEEE</label><input type="text" class="input-field" value="<?php echo $query3["beee"];?>"><br>
                <label>PHYSICS LAB</label><input type="text" class="input-field" value="<?php echo $query3["physicslab"];?>"><br>
                <label>ENGLISH LAB</label><input type="text" class="input-field" value="<?php echo $query3["englishlab"];?>"><br>
                <label>C++ LAB</label><input type="text" class="input-field" value="<?php echo $query3["cpplab"];?>"><br>
                <label>WORKSHOP</label><input type="text" class="input-field" value="<?php echo $query3["workshop"];?>"><br>
               <button type="submit" class="submit-btn">Edit</button>
               <input type="file" id="file" accept="pdf/*"/>
               <div class="upload"><label for="file"><a href="memouploads/<?php echo $query3['s2memo'];?>" download>Download memo</a></label></div> 
            </form>
            </div>
        </div>
      <script>
