...
<head>
    ...
    <script>
          function valid()
          {
            var studentid=document.student.proctorid.value;
...
<div class="wrapper">
  <div class="navbar1">
    ...
    <div class="navbar_right">
      <div class="profile">
        <div class="icon_wrap">
          <img src="uploads/<?=$ro['profilepic']?>" alt="user">
          <span class="name"><?php echo $ro['name']?></span>
...
<div data-component="sidebar">
    ...
    <script src="https://kit.fontawesome.com/b99e675b6e.js"></script>
        <div id="search">
            <form action="proctordelete.php" name="student" onsubmit="return valid();" method="post">
              <input type="text" name="proctorid" placeholder="enter proctor_id" required>
            ...
            <div class="searchresults">
                ...
                <?php
                 ...
                 if(isset($_POST['search']) && isset($_POST['proctorid']))
                 {
                     $b=$_POST['proctorid'];
                     $s="select proctorid,name from proctorlogin where proctorid='$b'";
                 }
                 else
                  {
                  ...
                  while($row=mysqli_fetch_assoc($query))
                  {
                      ...
                      <centre>
                      <td><form action="proctordelete.php" method="post">
                     <centre><button type="submit" id="deletebutton" name="delete" value="<?php echo $row['proctorid']?>">Delete</button></centre>
                      </form>
                      </td>
                      </centre>
                      </tr>
                ...
                {
                    $query=$_POST['delete'];
                    $s="delete from proctorlogin where proctorid='$query'";
                    $res=mysqli_query($con,$s);
                    echo '<script>window.location.href="proctordelete.php"</script>';
                }
               ?>
            </div>
        </div>
