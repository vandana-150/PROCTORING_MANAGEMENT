...
<div data-component="sidebar">
    ...
    <div class="hero">
            ...
            <form id="mid1form" class="input-group">

        <label>ENGLISH</label><input type="text" class="input-field" value="<?php echo $query1["english"];?>">
        <label>M1</label><input type="text" class="input-field" value="<?php echo $query1["m1"];?>">
        <label>CHEMISTRY</label><input type="text" class="input-field" value="<?php echo $query1["chemistry"];?>">
        <label>BEE</label><input type="text" class="input-field" value="<?php echo $query1["bee"];?>">
        <label>PEHV</label><input type="text" class="input-field" value="<?php echo $query1["pehv"];?>">
            </form>

            <form id="mid2form" class="input-group">
            <label>ENGLISH</label><input type="text" class="input-field" value="<?php echo $query2["english"];?>"><br>
            <label>M1</label><input type="text" class="input-field" value="<?php echo $query2["m1"];?>"><br>
            <label>CHEMISTRY</label><input type="text" class="input-field" value="<?php echo $query2["chemistry"];?>"><br>
            <label>BEE</label><input type="text" class="input-field" value="<?php echo $query2["bee"];?>"><br>
            <label>PEHV</label>   <input type="text" class="input-field" value="<?php echo $query2["pehv"];?>"><br>
            </form>

            <form id="sem1form" class="input-group">
                <label>ENGLISH</label><input type="text" class="input-field" value="<?php echo $query3["english"];?>"><br>
                <label>M1</label><input type="text" class="input-field" value="<?php echo $query3["m1"];?>"><br>
                <label>CHEMISTRY</label><input type="text" class="input-field" value="<?php echo $query3["chemistry"];?>"><br>
                <label>BEE</label><input type="text" class="input-field" value="<?php echo $query3["bee"];?>"><br>
                <label>PEHV</label><input type="text" class="input-field" value="<?php echo $query3["pehv"];?>"><br>
                <label>CHEMISTRY LAB</label><input type="text" class="input-field" value="<?php echo $query3["chemistrylab"];?>"><br>
                <label>C LAB</label><input type="text" class="input-field" value="<?php echo $query3["clab"];?>"><br>
              
                <div class="upload"><label><a>Download memo</a></label></div>
            </form>
            </div>
        </div>
      <script>
...
window.location.href='proctorprofile.php';
})
})
        </script>
</body>
