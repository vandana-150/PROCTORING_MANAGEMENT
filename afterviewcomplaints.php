...
$query=$_SESSION["stuid"];
      ...
      $row1=mysqli_query($con,"select * from complaints where studentid='$query'");
...
<div data-component="sidebar">
    ...
    <form class="well form-horizontal"  name="complaint" method="post" onsubmit="return valid();"  id="contact_form" style="margin:10%;">
<fieldset>
  ...
  <label class="col-md-4 control-label">STUDENT ID</label>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
          <input class="form-control" name="studentid" type="text" value="<?php echo $query1["studentid"];?>"></input>
  </div>
  </div>
</div>
<!-- Text area -->
  ...
  <label class="col-md-4 control-label">COLLEGE COMPLAINTS</label>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
          <textarea class="form-control" name="college"><?php echo $query1["college"];?></textarea>
  </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label">HOSTEL COMPLAINTS</label>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
          <textarea class="form-control" name="hostel"><?php echo $query1["hostel"];?></textarea>
  </div>
  </div>
</div>
<!-- Text area -->
...
<div class="form-group">
  <label class="col-md-4 control-label">OTHER COMPLAINTS</label>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
          <textarea class="form-control" name="other"><?php echo $query1["others"];?></textarea>
  </div>
  </div>
</div>
