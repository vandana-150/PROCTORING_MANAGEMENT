                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <form id="register-form" role="form" action="forgotcoordinator.php" autocomplete="off" class="form" method="post">
                            ...
                            <div>
                                Remember?    <a href="logincoordinator.php" style="text-decoration: none;font-size:15px">Signup</a>
                            </div>
                            ...
                            <?php
                                ...
                                if(isset($_POST['recover-submit'])){
                                    $var=$_POST['email'];
                                    $query="select * from coordinatorlogin where email='$var'";
                                ...
                                http://localhost/proctoring/resetcoordinator.php
                                With Regards
                                Admin
                                ...
                                Anil Nerukonda Institute Of Techonology and Sciences.";
                                        ...
                                        if(mail($var,$sub,$msg)){
                                            ...
                                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                            <strong>Success!</strong>Link is sent to your Email.
                                            </div>
                                        <?php
                                        }
                                        else{
