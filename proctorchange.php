...
$con=mysqli_connect('localhost','root','','project');
        ...
        $reg=$_SESSION['user'];
        $s="select * from coordinatorlogin where username='$reg'";
    ...
    <div class="navbar_right">
      <div class="profile">
        ...
        <div class="profile_dd">
          <ul class="profile_ul">
            <li class="profile_li"><a class="profile" href="coordinatorprofile.php"><span class="picon"><i class="fas fa-user-alt"></i> </span>Profile</a>
            </li>
...
<div data-component="sidebar">
      <div class="sidebar">
        <ul class="list-group flex-column d-inline-block first-menu">
          <li class="list-group-item pl-3 py-2">
            <a href="#"><i class="fa fa-user-o" aria-hidden="true" ><span class="ml-2 align-middle">PROCTOR</span></i></a>
            <ul class="list-group flex-column d-inline-block submenu" style="margin-top: 1%;">
                <li class="list-group-item pl-4" style="margin-top:20%;">
                  <a href="proctoradd.php" class="">ADD</a><br><br>
                </li> <!-- end Posts -->
      
                <li class="list-group-item pl-4">
                  <a href="proctordelete.php" class="">DELETE</a><br><br>
                </li> <!-- end Blog Assist -->         
              </ul> <!-- /.submenu -->
          </li> <!-- /.list-group-item -->
    
          <li class="list-group-item pl-3 py-2">
            <a href="#"><i class="fa fa-user-o" aria-hidden="true"><span class="ml-2 align-middle">STUDENT</span></i></a>
            <ul class="list-group flex-column d-inline-block submenu" style="margin-top: 1%;">
              <li class="list-group-item pl-4" style="margin-top:20%;">
                <a href="studentadd.php" class="">ADD</a><br><br>
    
              </li> <!-- end Posts -->
    
              <li class="list-group-item pl-4">
                <a href="studentdelete.php" class="">DELETE</a><br><br>
              </li> <!-- end Blog Assist -->
    
              <li class="list-group-item pl-4">
                <a href="proctorchange.php" class="">CHANGE</a><br><br>
              </li> <!-- end Pages -->
    ...
    <script src="https://kit.fontawesome.com/b99e675b6e.js"></script>
        <div id="search">
            <form action="proctorchange.php" name="changes" onsubmit="return valid();" method="post" style="display:flex; justify-content:space-around; margin-right:30%; margin:10%;">
              <input type="text" name="old_proctorid" placeholder="enter old proctor_id" required><br>
              <input type="text" name="new_proctorid" placeholder="enter new proctor_id" required>
              <br>
            <centre> <button type="submit" name="change" style="width:100%; cursor:pointer;">CHANGE</button></centre>
            </form>
            <div class="searchresults">
                ...
                <?php
                 ...
                 {
                     $old_proctorid=$_POST['old_proctorid'];
                     $new_proctorid=$_POST['new_proctorid'];
                     $s="update studentlogin set proctorid='$new_proctorid' where proctorid='$old_proctorid'";
                     $check1=mysqli_query($con,"select * from proctorlogin where proctorid='$old_proctorid'");
                     $check2=mysqli_query($con,"select * from proctorlogin where proctorid='$new_proctorid'");
                  if(mysqli_num_rows($check1)<=0)
                  {
                    echo "<script>alert('old_proctorid not exist');</script>";
                  }
                  else if(mysqli_num_rows($check2)<=0)
                  {
                    echo "<script>alert('new_proctorid not exist');</script>";
                  }
                  ...
                  {
                      $s="select proctorid,name from proctorlogin";
                  }
                  $query=mysqli_query($con,"select proctorid,name from proctorlogin");
                  while($row=mysqli_fetch_assoc($query))
                  {
                      ?>
                      <tr style="border: 1px solid black;">
                      <td><centre><?php echo $row['proctorid']?></centre></td>
                      <centre><td><?php echo $row['name']?></td></centre>
                      </tr>
                      <?php
                  }
                  ?>
