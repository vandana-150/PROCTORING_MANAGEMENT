      ...
      <div class="col-lg-4" style="border:2px solid #ccc;">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <p class="mb-0"><strong class="pr-1">Brach:</strong>CSE</p>
            <p class="mb-0"><strong class="pr-1">Section:</strong>C</p>
          </div>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <form action="profile.php" onsubmit="return validateImage();"name="update" method="POST" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-group">
              <label class="form-label" style="color: black;">Academic Year:</label>
              <input type="text" class="form-control" name='academic_year' id="academic_year" value="<?php  echo $row['academic_year']?>" placeholder="enter email" >
            </div>
            <div class="form-group">
              <label class="form-label" style="color: black;">Gender:</label>
              <input type="text" class="form-control" name='gender' id="gender" value="<?php  echo $row['gender']?>" placeholder="enter email" >
            </div>
            <div class="form-group">
              <label class="form-label" style="color: black;">Religion:</label>
              <input type="text" class="form-control" name='religion' id="religion" value="<?php  echo $row['religion']?>" placeholder="enter email" >
            </div>
            <div class="form-group">
              <label class="form-label" style="color: black;">Blood:</label>
              <input type="text" class="form-control" name='blood' id="blood" value="<?php  echo $row['blood']?>" placeholder="enter email" >
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name='address' id="address" value="<?php  echo $row['address']?>" placeholder="enter email" >
            </div>
      ...
      <form name='change' action="" method="POST">
        ...
        <div class="modal-footer">
          ...
          <?php
            ...
            {
              $before=$row['studentid'];
              $new_cur=$_POST['curpass'];
              $new_pass=$_POST['newpass'];
              $connew_pass=$_POST['connewpass'];
              $query="update studentlogin set password='$new_pass' where studentid= '$before'";
...
<?php
  if(isset($_POST['submit'])){
    ...
    $modified_blood=$_POST['blood'];
    $modified_religion=$_POST['religion'];
    $modified_gender=$_POST['gender'];
    $modified_academic=$_POST['academic_year'];

    $query="update details set name='$modified_name',address='$modified_address',phone='$modified_phone',academic_year='$modified_academic',blood='$modified_blood',religion='$modified_religion',gender='$modified_gender'";
              ...
              if ($error == 0) {
                if ($img_size > 1024000) {
                  ...
                  if (in_array($img_ex_lc, $allowed_exs)) {
                    ...
                    $user=$_SESSION["regno"];
                    $query="update details set profilepic='$new_img_name' where studentid= '$user'";
