...
<head>
    ...
    <title>Proctor Attendance</title>
    <style>
...
<div class="wrapper">
  <div class="navbar1">
    ...
    <div class="navbar_right">
      <div class="profile">
        <div class="icon_wrap">
        <img src="uploads/<?=$ro['profilepic']?>" alt="profile_pic">
...
<legend><h2 style="text-align:center;">Attendance Sheet</h2></legend>
<center>
 <table style="width: 50%;" class="table table-dark table-hover">
 <thead>
  <tr>
    <th>STUDENTID</th>
    <th>ATTENDANCE</th>
  ...
  <?php
   $query=mysqli_query($con,"select studentid from studentlogin");
   ...
   while($row=mysqli_fetch_assoc($query))
    {
        ...
        <form action="proctorattendance.php" method="post">
        <td><centre>     
         <div class="form-group"> 
          <div class="col-md-4 inputGroupContainer">
          <div class="input-group">
          <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
          <input  name="percent[]" placeholder="Enter Attendance" class="form-control"  type="text" style="width:100%;background:transparent;border:none; color:white;">
          </div>
        </div>
        </div>
        </centre>
...
<?php
   if(isset($_POST['submit']))
   {
    ...
    while($row=mysqli_fetch_assoc($query))
    {
        $percentage=$a[$j];
        $id=$row['studentid'];
        $b="update attendance set percentage='$percentage' where studentid='$id'";
