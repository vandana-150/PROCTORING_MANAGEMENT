   ...
   <body>
    <nav>
      ...
      <div class="login-box">
        ...
        <form method="post" name="login" onsubmit="return valid();" action="logincoordinator.php">
            <div class="user-box">
            ...
            <button onclick="location.replace('forgotcoordinator.php')">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
...
if(isset($_POST['submit']))
{
    ...
    $query=mysqli_query($con,"select * from coordinatorlogin where username='$username' and password='$password'");
...
else
{
  $_SESSION['user']=$username;
    ...
    echo '<script>window.location.href="coordinatorsidebar.php"</script>';
}
}
?>