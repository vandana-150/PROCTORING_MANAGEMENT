                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <div>
                                Remember?    <a href="loginstudent.php" style="text-decoration: none;font-size:15px">Signup</a>
                            </div>
                            ...
                            <?php
                                ...
                                if(isset($_POST['recover-submit'])){
                                    $var=$_POST['email'];
                                    $query="select * from studentlogin where email='$var'";
                                ...
                                http://localhost/proctoring/reset.php
                                With Regards
                                Admin
