    ...
    <div class="hero">
            <div class="form-box">
                <div class="button-box">
                    ...
                    <button type="button" class="toggle-btn" onclick="sem1form()">SEM 2</button>
                </div>
            <form id="mid1form" name="mid1" action="midmarks.php" method="post" onsubmit="return valid1();" class="input-group">
        <label>M2</label><input type="text" name="english1" class="input-field" value="<?php echo $query1["m2"];?>" required>
        <label>PHYSICS</label><input type="text" name="m11" class="input-field" value="<?php echo $query1["physics"];?>" required>
        <label>ES</label><input type="text" name="chemistry1" class="input-field" value="<?php echo $query1["es"];?>" required>
        <label>ED</label><input type="text" name="bee1" class="input-field" value="<?php echo $query1["ed"];?>" required>
        <label>BEEE</label><input type="text" name="pehv1" class="input-field" value="<?php echo $query1["beee"];?>" required>
            ...
            <label>M2</label><input type="text" name="english2" class="input-field" value="<?php echo $query2["m2"];?>" required><br>
            <label>PHYSICS</label><input type="text" name="m12" class="input-field" value="<?php echo $query2["physics"];?>" required><br>
            <label>ES</label><input type="text" name="chemistry2" class="input-field" value="<?php echo $query2["es"];?>" required><br>
            <label>ED</label><input type="text" name="bee2" class="input-field" value="<?php echo $query2["ed"];?>" required><br>
            <label>BEEE</label>   <input type="text" name="pehv2" class="input-field" value="<?php echo $query2["beee"];?>" required><br>
               <button type="submit" name="mid2submit" class="submit-btn">Submit</button>
            </form>

            <form id="sem1form" name="sem1" action="midmarks.php" method="post" onsubmit="return valid3();" enctype="multipart/form-data" class="input-group">
                <label>M2</label><input type="text" name="english3" class="input-field" value="<?php echo $query3["m2"];?>" required><br>
                <label>PHYSICS</label><input type="text" name="m13" class="input-field" value="<?php echo $query3["physics"];?>" required><br>
                <label>ES</label><input type="text" name="chemistry3" class="input-field" value="<?php echo $query3["es"];?>" required><br>
                <label>ED</label><input type="text" name="bee3" class="input-field" value="<?php echo $query3["ed"];?>" required><br>
                <label>BEEE</label><input type="text" name="pehv3" class="input-field" value="<?php echo $query3["beee"];?>" required><br>
                <label>PHYSICS LAB</label><input type="text" name="chemistrylab3" class="input-field" value="<?php echo $query3["physicslab"];?>" required><br>
                <label>ENGLISH LAB</label><input type="text" name="clab3" class="input-field" value="<?php echo $query3["englishlab"];?>" required><br>
                <label>C++ LAB</label><input type="text" name="cpplab" class="input-field" value="<?php echo $query3["cpplab"];?>" required><br>
                <label>WORKSHOP</label><input type="text" name="workshop" class="input-field" value="<?php echo $query3["workshop"];?>" required><br>
...
if(isset($_POST['mid1submit']))
{
    ...
    $bee=$_POST['bee1'];
    $pehv=$_POST['pehv1'];
    $query="update mid1 set m2='$english',physics='$m1',es='$chemistry',ed='$bee',beee='$pehv' where studentid='$regno'";
...
else if(isset($_POST['mid2submit']))
{
    ...
    $bee=$_POST['bee2'];
    $pehv=$_POST['pehv2'];
    $query="update mid2 set m2='$english',physics='$m1',es='$chemistry',ed='$bee',beee='$pehv' where studentid='$regno'";
    if(!mysqli_query($con,$query))
    {
        echo "not inserted";
    }
...
else if(isset($_POST['sem1submit']))
{
    ...
    $query="update sem1 set m2='$english',physics='$m1',es='$chemistry',ed='$bee',beee='$pehv',physicslab='$chemistrylab',englishlab='$clab',cpplab='$cpplab',workshop='$workshop',s2memo='$new_img_name' where studentid='$regno'";
    if(!mysqli_query($con,$query))
    {
