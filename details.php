...
<div class="wrapper">
  <div class="navbar1">
    ...
    <div class="navbar_right">
      <div class="profile">
        <div class="icon_wrap">
          <img src="uploads/<?=$query1['profilepic']?>" alt="user">
          <span class="name"><?php echo $query1['name']?></span>
...
<div data-component="sidebar">
    ...
    <form class="well form-horizontal" action="details.php" method="post"  id="contact_form" style="margin: 5%;">
<fieldset>
...
<div class="form-group">
  ...
  <input  name="name" placeholder="Enter Name" class="form-control"  type="text" value="<?php echo $query1["name"];?>">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Student Id</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="admissionnumber" placeholder="Enter Student Id" class="form-control"  type="text" value="<?php echo $query1["studentid"];?>">
    </div>
  </div>
</div>
<!-- radio checks -->
...
<div class="form-group">
  <label class="col-md-4 control-label" >Academic Year</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
  <input name="academic_year" placeholder="Enter Academic Year" class="form-control"  type="text" value="<?php echo $query1["academic_year"];?>">
    </div>
  </div>
</div>
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="fathername" placeholder="Enter Father Name" class="form-control"  type="text" value="<?php echo $query1["fathername"];?>">
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="profession" placeholder="Enter Profession" class="form-control"  type="text" value="<?php echo $query1["profession"];?>">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label">Phone #</label>  
    ...
    <input name="phone" placeholder="(845)555-1212" class="form-control" type="text" value="<?php echo $query1["phone"];?>">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label">Address</label>  
    ...
    <div class="input-group">
        ...
        <textarea class="form-control" name="address" placeholder="ENTER ADDRESS"><?php echo $query1["address"];?></textarea>
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label">SSC MARKS</label>  
    ...
    <input name="sscmarks" placeholder="ENTER SCC MARKS" class="form-control" type="text" value="<?php echo $query1["sscmarks"];?>">
    </div>
  </div>
</div>
<div class="form-group">
  <label class="col-md-4 control-label">INTERMEDIATE MARKS</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
    <input name="intermarks" placeholder="ENTER INTERMEDIATE MARKS" class="form-control" type="text" value="<?php echo $query1["intermarks"];?>">
    </div>
  </div>
</div>
<div class="form-group">
  <label class="col-md-4 control-label">EMACET / ECET RANK</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
    <input name="rank" placeholder="ENTER RANK" class="form-control" type="text" value="<?php echo $query1["rank"];?>">
    </div>
  </div>
</div>
<!-- Select Basic -->
...
<div class="form-group"> 
  <label class="col-md-4 control-label">Blood</label>
    ...
    <select name="blood" class="form-control selectpicker" >
      <option value="<?php echo $query1["blood"];?>" >Please select your blood group</option>
    <option>A +VE</option>
    <option>A -VE</option>
...
<div class="form-group"> 
  <label class="col-md-4 control-label">Religion</label>
    ...
    <select name="religion" class="form-control selectpicker" >
      <option value="<?php echo $query1["religion"];?>" >Please select your religion</option>
...
<div class="form-group">
  <label class="col-md-4 control-label">ACTIVITIES</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
    <input name="activities" placeholder="ENTER ACTIVITIES" class="form-control" type="text" value="<?php echo $query1["activities"];?>">
    </div>
  </div>
</div>
<div class="form-group">
  <label class="col-md-4 control-label">SPORTS</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
    <input name="sports" placeholder="ENTER SPORTS" class="form-control" type="text" value="<?php echo $query1["sports"];?>">
    </div>
  </div>
</div>
<div class="form-group">
  <label class="col-md-4 control-label">SCHOLARSHIPS</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
    <input name="scholarships" placeholder="ENTER SCHOLARSHIPS" class="form-control" type="text" value="<?php echo $query1["scholarships"];?>"> 
    </div>
  </div>
</div>
<div class="form-group">
  <label class="col-md-4 control-label">PRIZES</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
    <input name="prizes" placeholder="ENTER PRIZES" class="form-control" type="text" value="<?php echo $query1["prizes"];?>">
    </div>
  </div>
</div>
<div class="form-group">
  <label class="col-md-4 control-label">AWARDS</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
    <input name="awards" placeholder="ENTER AWARDS" class="form-control" type="text" value="<?php echo $query1["awards"];?>">
    </div>
  </div>
</div>
<!-- Text area -->
  ...
  <label class="col-md-4 control-label">HOBBIES</label>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
            <textarea class="form-control" name="hobbies" placeholder="ENTER HOBBIES"><?php echo $query1["hobbies"];?></textarea>
  </div>
  </div>
</div>
...
if(isset($_POST['submit']))
{
    ...
    $que=mysqli_query($con,"select * from details where studentid='$studentid'");
...
else
{
    ...
    $query="update details set name='$name',academic_year='$academicyear',gender='$gender',blood='$blood',religion='$religion',dateofbirth='$dateofbirth',fathername='$fathername',profession='$profession',phone='$mobile',address='$address',sscmarks='$ssc',intermarks='$inter',rank='$eamcet',activities='$activities',sports='$sports',scholarships='$scholarships',prizes='$prizes',awards='$awards',hobbies='$hobbies' where studentid='$studentid'";
