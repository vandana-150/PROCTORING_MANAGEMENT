...
<head>
  ...
  function valid()
  {
    var studentid=document.complaint.studentid.value;
    var numbers=/^[0-9]*$/;
...
<div data-component="sidebar">
    ...
    <form class="well form-horizontal" action="complaints.php" name="complaint" method="post" onsubmit="return valid();"  id="contact_form" style="margin:10%;">
<fieldset>

<!-- Form Name -->
<legend><h2 style="text-align:center;">Complaints Form</h2></legend>
  ...
  <label class="col-md-4 control-label">STUDENT ID</label>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
          <input class="form-control" name="studentid" placeholder="ENTER STUDENTID" type="text"></input>
  </div>
  </div>
</div>
<!-- Text area -->
...
<div class="form-group">
  <label class="col-md-4 control-label">COLLEGE COMPLAINTS</label>
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
          <textarea class="form-control" name="college" placeholder="ENTER COLLEGE COMPLAINTS"></textarea>
  </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label">HOSTEL COMPLAINTS</label>
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
          <textarea class="form-control" name="hostel" placeholder="ENTER HOSTEL COMPLAINTS"></textarea>
  </div>
  </div>
</div>
<!-- Text area -->
...
<div class="form-group">
  <label class="col-md-4 control-label">OTHER COMPLAINTS</label>
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
          <textarea class="form-control" name="other" placeholder="ENTER OTHER COMPLAINTS"></textarea>
  </div>
  </div>
</div>
...
if(isset($_POST['submit']))
{
    ...
    $hostel=$_POST['hostel'];
    $others=$_POST['other'];
    $query="update complaints set college='$college',hostel='$hostel',others='$others' where studentid='$studentid'";
    $check=mysqli_query($con,"select * from studentlogin where studentid='$studentid'");
    if(mysqli_num_rows($check)<=0)
    {
        echo "<script>alert('Enter valid studentid');</script>";
